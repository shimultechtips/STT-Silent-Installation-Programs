...
int main() // Main Method...
{
    ...
    string fileName = "MAS (KMS38)"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/KMS38";  // This Line Of Code Is Used For EXE Parameter...
    string drive = "Microsoft Activation Script - shimultechtips.cmd";
