...
int main() // Main Method...
{
    ...
    /*---------------------------------------------------------*/
    string drive = "AnyDesk For Win XP And Later - shimultechtips.exe";// This Line Of Code Is Used For Searching Mounted Drive...
    string fileName = "AnyDesk"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "--install \"C:\\Program Files\\AnyDesk\" --silent --create-shortcuts --create-desktop-icon";  // This Line Of Code Is Used For EXE Parameter...
