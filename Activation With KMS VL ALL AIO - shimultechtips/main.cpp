...
int main() // Main Method...
{
    ...
    string fileName = "KMS VL ALL AIO"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/a";  // This Line Of Code Is Used For EXE Parameter...
    string drive = "KMS VL ALL AIO - shimultechtips.cmd";
