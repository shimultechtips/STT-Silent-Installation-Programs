...
int main() // Main Method...
{
    ...
    system("C:\\Windows\\System32\\UserAccountControlSettings.exe");
    string command = "\"" + current_working_dir + "\\WinCDEmu Silent Installer - shimultechtips.exe\"";
    system(command.c_str());
    string command2 = "\"start \"\" \"" + current_working_dir + "\\All Files\\$ - Tools\\SIPS - shimultechtips.exe\"\"";
