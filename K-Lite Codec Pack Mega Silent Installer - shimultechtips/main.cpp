...
int main() // Main Method...
{
    ...
    string fileName = "K-Lite Codec Pack Mega"; // This Line Of Code Is Used For Filename Of The EXE...

    char buffer[MAX_PATH];
    GetModuleFileName(NULL, buffer, MAX_PATH);
    string::size_type pos = string(buffer).find_last_of("\\/");
    string current_working_dir = string(buffer).substr(0, pos);
    string parameterOfEXE = "/VERYSILENT /NORESTART /SUPPRESSMSGBOXES /LOADINF=\"" + current_working_dir + "\\Unattended Settings - shimultechtips.ini\"";// This Line Of Code Is Used For EXE Parameter...

    /*---------------------------------------------------------*/
    switch(archVersion)
    {
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "K-Lite Codec Pack Mega For Win 7 And Later - shimultechtips.exe";
    ...
    case 51://This Case Is For Windows XP x64...
        drive = "K-Lite Codec Pack Mega For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
