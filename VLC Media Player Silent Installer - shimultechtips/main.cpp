...
int main() // Main Method...
{
   // Sets The Console Window Color And Window Size...
    ...
    string fileName = "VLC Media Player"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/L=1033 /S /NCRC";  // This Line Of Code Is Used For EXE Parameter...

    system("if exist \"C:\\Program Files\\VideoLAN\\VLC\\uninstall.exe\" \"C:\\Program Files\\VideoLAN\\VLC\\uninstall.exe\" /S");
    system("if exist \"C:\\Program Files (x86)\\VideoLAN\\VLC\\uninstall.exe\" \"C:\\Program Files (x86)\\VideoLAN\\VLC\\uninstall.exe\" /S");

    /*---------------------------------------------------------*/
    switch(archVersion)
    {
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "VLC Media Player x64 For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 100://This Case Is For Windows 10 x86...
        drive = "VLC Media Player x86 For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
