...
int main() // Main Method...
{
    ...
    string fileName = "Bijoy 52"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "";  // This Line Of Code Is Used For EXE Parameter...

    system("taskkill /f /im BijoyBayanno.exe");

    /*---------------------------------------------------------*/
    switch(archVersion)
    {
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Bijoy 52 For Win 7 And Later - shimultechtips.exe";
    ...
    case 51://This Case Is For Windows XP x64...
        drive = "Bijoy 52 For Win XP - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
