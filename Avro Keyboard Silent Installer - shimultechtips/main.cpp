...
author();// Calls The author() Function...
    ...
    /*---------------------------------------------------------*/
    string drive = "Avro Keyboard For Win XP And Later - shimultechtips.exe";// This Line Of Code Is Used For Searching Mounted Drive...
    string fileName = "Avro Keyboard"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/silent";  // This Line Of Code Is Used For EXE Parameter...
    executeProgram(0, drive, parameterOfEXE, fileName);
    system("del /q \"C:\\Users\\Public\\Desktop\\Avro Spell Checker.lnk\"");
    system("del /q \"C:\\Documents and Settings\\All Users\\Desktop\\Avro Spell Checker.lnk\"");
