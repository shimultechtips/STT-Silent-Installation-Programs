...
int main() // Main Method...
{
    ...
    {
        mountISO(last_digit, "Microsoft Office 2007 - shimultechtips.iso");// Mounts The ISO...
        /*---------------------------------------------------------*/
        string drive;// This Line Of Code Is Used For Searching Mounted Drive...
        string fileName = "Microsoft Office 2007"; // This Line Of Code Is Used For Filename Of The EXE...
        string current_working_dir = searchMountedDrive("Microsoft Office 2007\\Silent.msp");
        string parameterOfEXE = "/adminfile " + current_working_dir;// This Line Of Code Is Used For EXE Parameter...

        /*---------------------------------------------------------*/
        drive = searchMountedDrive("Microsoft Office 2007\\setup.exe");
        executeProgram(1, drive, parameterOfEXE, fileName);
        drive = searchMountedDrive("Microsoft Office 2007\\Save As PDF and XPS Plugin For Office 2007 - shimultechtips.exe");
        executeProgram(1, drive, "", "PDF Plugin");
        system("explorer \"C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Microsoft Office\\\"");
