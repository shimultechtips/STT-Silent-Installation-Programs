...
int main() // Main Method...
{
    ...
    if (winCDEmu==1) // If winCDEmu=1, In Other Words If winCDEmu Installed, Only Then Run This Codes...
    {
        ...
        string fileName = "Adobe Photoshop"; // This Line Of Code Is Used For Filename Of The EXE...
        ...
        case 101://This Case Is For Windows 10 And 11 x64...
            mountISO(last_digit, "Illustrator CC 2019 - shimultechtips.iso");
            drive = searchMountedDrive("Adobe Illustrator CC 2019 v23.0.5.634 (x64) Pre-Activated\\Set-up.exe");
            executeProgram(1, drive, parameterOfEXE, fileName);
            break;
        case 100://This Case Is For Windows 10 x86...
            mountISO(last_digit, "Illustrator CS 11 - shimultechtips.iso");
            drive = searchMountedDrive("Illustrator CS 11\\Illustrator CS 11 Serial Key - shimultechtips.txt");
            executeProgram(1, drive, parameterOfEXE, fileName);
            drive = searchMountedDrive("Illustrator CS 11\\setup.exe");
            executeProgram(1, drive, parameterOfEXE, fileName);
            break;
