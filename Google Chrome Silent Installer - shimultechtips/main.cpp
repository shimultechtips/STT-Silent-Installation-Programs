...
int main() // Main Method...
{
    ...
    string fileName = "Google Chrome"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/silent /install";  // This Line Of Code Is Used For EXE Parameter...

    /*---------------------------------------------------------*/
    switch(archVersion)
    {
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Google Chrome x64 For Win 10 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 100://This Case Is For Windows 10 x86...
        drive = "Google Chrome x86 For Win 10 - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 61://This Case Is For Windows 7, 8 And 8.1 x64...
        drive = "Win XP-7 And Later\\Google Chrome x64 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 60://This Case Is For Windows 7, 8 And 8.1 x86...
        drive = "Win XP-7 And Later\\Google Chrome x86 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 51://This Case Is For Windows XP x64...
        drive = "Win XP-7 And Later\\Google Chrome For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
