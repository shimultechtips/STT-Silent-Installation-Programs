...
int main() // Main Method...
{
    ...
    if (winCDEmu==1) // If winCDEmu=1, In Other Words If winCDEmu Installed, Only Then Run This Codes...
    {
        ...
        case 101://This Case Is For Windows 10 And 11 x64...
            mountISO(last_digit, "Photoshop CC 2019 - shimultechtips.iso");
            drive = searchMountedDrive("Adobe Photoshop CC 2019 v20.0.10.120 Pre-Cracked\\Set-up.exe");
            executeProgram(1, drive, parameterOfEXE, fileName);
            break;
        case 100://This Case Is For Windows 10 x86...
            mountISO(last_digit, "Photoshop CS 8 - shimultechtips.iso");
            drive = searchMountedDrive("Photoshop CS 8\\setup.exe");
            executeProgram(1, drive, parameterOfEXE, fileName);
            break;
