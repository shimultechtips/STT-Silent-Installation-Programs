...
int main() // Main Method...
{
    ...
    string fileName = "Visual C++ Redist AIO"; // This Line Of Code Is Used For Filename Of The EXE...
    string parameterOfEXE = "/ai /gm2";  // This Line Of Code Is Used For EXE Parameter...

    /*---------------------------------------------------------*/
    switch(archVersion)
    {
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Visual C++ Redist AIO For Win 7 And Later - shimultechtips.exe";
    ...
    case 51://This Case Is For Windows XP x64...
        drive = "Visual C++ Redist AIO x64 For Win XP And Later - shimultechtips";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 50://This Case Is For Windows XP x86...
        drive = "Visual C++ Redist AIO x86 For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
