...
int main() // Main Method...
{
   // Sets The Console Window Color And Window Size...
    ...
    string fileName = "qBittorrent"; // This Line Of Code Is Used For Filename Of The EXE...
    ...
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "qBittorrent x64 For Win 10 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 100://This Case Is For Windows 10 x86...
        drive = "qBittorrent x64 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    ...
    case 60://This Case Is For Windows 7, 8 And 8.1 x86...
        drive = "qBittorrent x86 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 51://This Case Is For Windows XP x64...
        drive = "qBittorrent For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    ...
    system("xcopy \"C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\qBittorrent\\qBittorrent.lnk\" \"%userprofile%\\desktop\\\" /y");
    return 0;
}
