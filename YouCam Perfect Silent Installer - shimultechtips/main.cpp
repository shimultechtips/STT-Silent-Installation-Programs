...
int main() // Main Method...
{
    ...
    if (winCDEmu==1) // If winCDEmu=1, In Other Words If winCDEmu Installed, Only Then Run This Codes...
    {
        ...
        string fileName = "DirectX 12"; // This Line Of Code Is Used For Filename Of The EXE...
        string parameterOfEXE = "/silent";  // This Line Of Code Is Used For EXE Parameter...
        // Mounts The ISO...
        /*---------------------------------------------------------*/
        mountISO(last_digit, "YouCam Perfect - shimultechtips.iso");
        drive = searchMountedDrive("YouCam Perfect\\Setup.exe");
