...
int main() // Main Method...
{
    ...
    string fileName = "ESET Security"; // This Line Of Code Is Used For Filename Of The EXE...
    ...
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Eset Internet Security x64 For Win 10 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 100://This Case Is For Windows 10 x86...
        drive = "Eset Internet Security x86 For Win 10 - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 61://This Case Is For Windows 7, 8 And 8.1 x64...
        drive = "Win 7 And Later\\Eset Internet Security x64 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 60://This Case Is For Windows 7, 8 And 8.1 x86...
        drive = "Win 7 And Later\\Eset Internet Security x86 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 51://This Case Is For Windows XP x64...
        drive = "Win XP And Later\\Eset Smart Security x64 For XP And Later.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 50://This Case Is For Windows XP x86...
        drive = "Win XP And Later\\Eset Smart Security x86 For XP And Later.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
