...
int main() // Main Method...
{
    ...
    string fileName = "WinRAR"; // This Line Of Code Is Used For Filename Of The EXE...
    ...
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Win 7 And Later\\WinRAR x64 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 100://This Case Is For Windows 10 x86...
        drive = "Win 7 And Later\\WinRAR x86 For Win 7 And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    ...
    case 51://This Case Is For Windows XP x64...
        drive = "Win XP And Later\\WinRAR x64 For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
    case 50://This Case Is For Windows XP x86...
        drive = "Win XP And Later\\WinRAR x86 For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
