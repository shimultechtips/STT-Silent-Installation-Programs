...
int main() // Main Method...
{
   // Sets The Console Window Color And Window Size...
    ...
    string fileName = "Foxit Reader"; // This Line Of Code Is Used For Filename Of The EXE...
    ...
    case 101://This Case Is For Windows 10 And 11 x64...
        drive = "Foxit Reader For Win 7 And Later - shimultechtips.exe";
    ...
    case 51://This Case Is For Windows XP x64...
        drive = "Foxit Reader For Win XP And Later - shimultechtips.exe";
        executeProgram(0, drive, parameterOfEXE, fileName);
        break;
